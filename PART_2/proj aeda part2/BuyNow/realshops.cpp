...
RealShop::RealShop(string filename, string adress, string postal_code, string telephone) {
    read_products_file(filename);
...
void RealShop::read_products_file(const string& fileName)
{
    string name;
    int stock;
    string string_stock;
